...
const Stats = () => {
  return (
    <section id="stats" className="main-container react-activity-calendar" >
        ...
        <div className="streak-stats" id="github-streak-stats">
    ...
    <article id="github-stats-card" className="container-stats">
        ...
        <a id="github-top-langs" href="https://github.com/kirtirajingale/github-readme-stats">
          <img
            width="20px"
